...
class RegionCrossesData {
  static const Map<String, List<RegionCross>> crossesByRegion = {
    ...
    'desert': [
      RegionCross(id: 'd1', name: 'Le port de commerce de Solaris', x: 435.0, y: 483.0, angle: 0.0, size: 20.0, imagePath: 'assets/NomCitiesDesert/LePortDeCommerceDeSolaris.png', imageX: 0.0, imageY: 0.0),
      RegionCross(id: 'd2', name: 'La cité Solaris', x: 561.0, y: 431.0, angle: 30.0, size: 20.0, imagePath: 'assets/NomCitiesDesert/LaCitéSolaris.png', imageX: 0.0, imageY: 0.0),
      RegionCross(id: 'd3', name: 'Le coeur du désert', x: 669.0, y: 705.0, angle: 30.0, size: 20.0, imagePath: 'assets/NomCitiesDesert/LeCoeurDuDésert.png', imageX: 0.0, imageY: 0.0),
      RegionCross(id: 'd4', name: 'La piste des marchands', x: 645.0, y: 820.0, angle: 30.0, size: 20.0, imagePath: 'assets/NomCitiesDesert/LaPisteDesMarchands.png', imageX: 0.0, imageY: 0.0),
      RegionCross(id: 'd5', name: 'Le bain du désert', x: 399.0, y: 1002.0, angle: 30.0, size: 20.0, imagePath: 'assets/NomCitiesDesert/LeBainDuDésert.png', imageX: 0.0, imageY: 0.0),
      RegionCross(id: 'd6', name: 'L\'autel du soleil', x: 540.0, y: 1001.0, angle: 30.0, size: 20.0, imagePath: 'assets/NomCitiesDesert/AutelDuSoleil.png', imageX: 0.0, imageY: 0.0),
      RegionCross(id: 'd7', name: 'Le cimetières des géants', x: 651.0, y: 1179.0, angle: 30.0, size: 20.0, imagePath: 'assets/NomCitiesDesert/LeCimetièresDesGéants.png', imageX: 0.0, imageY: 0.0),
      RegionCross(id: 'd8', name: 'Le puits des Mirages', x: 664.0, y: 105.0, angle: 30.0, size: 20.0, imagePath: 'assets/NomCitiesDesert/LePuitsDesMirages.png', imageX: 0.0, imageY: 0.0),
      RegionCross(id: 'd9', name: 'Le piège des sables', x: 776.0, y: 427.0, angle: 30.0, size: 20.0, imagePath: 'assets/NomCitiesDesert/LePiègeDesSables.png', imageX: 0.0, imageY: 0.0),
      RegionCross(id: 'd10', name: 'La stelle du desert de Sahur', x: 824.0, y: 500.0, angle: 30.0, size: 20.0, imagePath: 'assets/NomCitiesDesert/LaStelleDuDesertDeSahur.png', imageX: 0.0, imageY: 0.0),
      RegionCross(id: 'd11', name: 'Le champs des épines', x: 914.0, y: 713.0, angle: 30.0, size: 20.0, imagePath: 'assets/NomCitiesDesert/LeChampsDesEpines.png', imageX: 0.0, imageY: 0.0),
      RegionCross(id: 'd12', name: 'La porte du désert', x: 917.0, y: 779.0, angle: 30.0, size: 20.0, imagePath: 'assets/NomCitiesDesert/LaPorteDuDésert.png', imageX: 0.0, imageY: 0.0),
      RegionCross(id: 'd13', name: 'Les monts de Sahur', x: 758.0, y: 927.0, angle: 30.0, size: 20.0, imagePath: 'assets/NomCitiesDesert/LesMontsDeSahur.png', imageX: 0.0, imageY: 0.0),      RegionCross(id:'d14', name:'Le passage secret', x:317.0, y:1540.0, angle:30.0, size:20.0, imagePath:'assets/NomCitiesDesert/LePassageSecret.png', imageX:0.0,imageY:0.0),
      RegionCross(id:'d15', name:'La grotte infini', x:383.0, y:1156.0, angle:30.0, size:20.0, imagePath:'assets/NomCitiesDesert/LaGrotteInfini.png', imageX:0.0, imageY:0.0),
      RegionCross(id:'d16', name:'L\'oasis de l\'exil', x:194.0, y:1497.0, angle:30.0, size:20.0, imagePath:'assets/NomCitiesDesert/OasisDeExil.png', imageX:0.0, imageY:0.0),
    ],
    'lac': [
